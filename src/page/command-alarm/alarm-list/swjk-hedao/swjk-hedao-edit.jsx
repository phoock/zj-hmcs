...
class SwjkHedaoEdit extends React.Component{
  constructor(props){
    super(props)
    this.state = {
      name : '',
  ...
  render(){
    return (
      <div>
        <div className="row">
          <div className="col-md-2 text-right"><label style={{display:'inline-block',lineHeight:'26px'}}>请选择河道名称:</label></div>
