...
class HuaStep04 extends React.Component{
  constructor(props){
    super(props)
    this.state = {
      dataSource : [
      ...
      <Card title="上传设计方案" style={{ marginTop: 16 }}>
        <div className="row" style={{ marginTop: 16 }}>
          <div className="col-md-8 col-sm-12">
            <Upload {...propsFun('0')}>
              <Button>
                <Icon type="upload" /> 请上传规划设计方案(依据选址意见书纳入相应的海绵要求和指标)
              </Button>
            </Upload>
          </div>
        </div>
