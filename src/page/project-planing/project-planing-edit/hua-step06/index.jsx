...
class HuaStep06 extends React.Component{
  constructor(props){
    super(props)
    this.state = {
      dataSource : [
    ...
    const uploadInfo = (this.props.nowStep-this.props.successStep)===1?(<Card title="上传设计方案" style={{ marginTop: 16 }}>
      <div className="row" style={{ marginTop: 16 }}>
        <div className="col-md-8 col-sm-12">
          <Upload {...propsFun('0')} name={`fff_1`}>
            <Button>
              <Icon type="upload"/> 请上传用地许可申请
            </Button>
          </Upload>
        </div>
      </div>
      <div className="row" style={{ marginTop: 16 }}>
        <div className="col-md-8 col-sm-12">
          <Upload {...propsFun('1')} name={`fff_2`}>
            <Button>
              <Icon type="upload"/> 请上传项目批准、核准或备案文件
            </Button>
          </Upload>
        </div>
      </div>
