      ...
      <div>
        {
          this.state.editDept
          ?
          <ProjectPlaningEdit {...this.props} editDept={this.state.editDept }></ProjectPlaningEdit>
          : null
        }
        ...
        return (
            <div className="row project-planing-edit" style={{marginTop:40}}>
                <div className="col-md-12">
                    <Card title={this.state.title} extra={<Link to={`/project-planing/map`}><i className = "fa fa-angle-left" >返回</i></Link>} bordered={true} style={{
                            background: '#fff'
                        }}>
                      <div className="row">
                      {
