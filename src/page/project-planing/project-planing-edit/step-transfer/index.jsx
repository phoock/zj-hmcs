  ...
  render(){
    const huaboEle = ()=>{
      switch (this.props.nowStep) {
        case 1: return <HuaStep01 projectName={this.state.projectName} {...this.props}/>
        case 2: return <HuaStep02 projectName={this.state.projectName} {...this.props}/>
        case 3: return <HuaStep03 projectName={this.state.projectName} {...this.props}/>
        case 4: return <HuaStep04 projectName={this.state.projectName} {...this.props}/>
        case 5: return <HuaStep05 projectName={this.state.projectName} {...this.props}/>
        case 6: return <HuaStep06 projectName={this.state.projectName} {...this.props}/>
        case 7: return <HuaStep07 projectName={this.state.projectName} {...this.props}/>
        case 8: return <HuaStep08 projectName={this.state.projectName} {...this.props}/>
        case 9: return <HuaStep09 projectName={this.state.projectName} {...this.props}/>
